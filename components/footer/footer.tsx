import FooterCol from "./col"

const Footer: React.FC = () => {
    return (
        <footer>
            <div className="bg-gray-100 mb-8">
                <div className="container mx-auto flex flex-col md:flex-row items-center md:h-24 h-36 justify-center md:gap-32">
                    <div className="text-3xl font-bold mb-8 md:mb-0">
                        Follow Us
                    </div>
                    <div className="flex items-center justify-center gap-8 md:gap-32">
            ...
            <div className="flex md:flex-row flex-col justify-center text-gray-700">
            ...
            <div className="p-4 flex-col md:flex-row text-sm text-gray-300 flex justify-between">
