                    ...
                    <div className='md:flex justify-between h-20 items-center'>
                        <div className="flex items-center">
                            ...
                            <ul className='flex uppercase font-medium'>
                                <li className="w-36 h-20 flex items-center justify-center">Home</li>
                                <li className="w-36 h-20 flex items-center justify-center">BLOG</li>
                                <li className="w-36 h-20 flex items-center justify-center">RANKING</li>
                                <li className="w-36 h-20 flex items-center justify-center">CHART</li>
                            </ul>
                        </div>
                        <div className="flex gap-4 items-center">
                            <div className="border rounded flex text-gray-500 items-center">
                                <input type="text" className="w-96 h-full px-3 py-2 w-72 rounded" placeholder="Search Luxey's" />
                                <span className="mr-3">
