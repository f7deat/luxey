        ...
        <div className='relative overflow-hidden bg-cover bg-no-repeat p-12 text-center jumbotron h-full' style={{
          ...
          <div className='absolute top-0 right-0 bottom-0 left-0 h-full w-full overflow-hidden bg-fixed' style={{
            ...
            <div className='container flex-col gap-4 px-4 mx-auto text-white items-center flex justify-center h-full'>
              ...
              <div className='text-lg uppercase'>Notify me when its ready</div>
              <input placeholder='Enter your email' className='text-gray-800 text-xl px-6 py-2 rounded bg-white shadow-lg md:w-96' type='text' />
              <button type='button' className='border border-white uppercase px-8 py-2 rounded shadow-lg hover:bg-white hover:text-gray-900'>
                <Space>
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
                    <path strokeLinecap="round" strokeLinejoin="round" d="M6 12L3.269 3.126A59.768 59.768 0 0121.485 12 59.77 59.77 0 013.27 20.876L5.999 12zm0 0h7.5" />
                  </svg>
                  <span className='text-lg font-medium' onClick={onSubmit}>Submit</span>
                </Space>
              </button>
            </div>
